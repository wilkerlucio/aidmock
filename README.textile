...
With Aidmock we don't recommend you to do these things, because this way the mock object will be an instance of a mock from your framework, and we can't realize which class you are trying to mock. Instead, you should do this:
