...
| Class          | "KindOfMatcher":#kind_of_matcher     | if object is class, it will create a @KindOfMatcher@ with the given class                              |
| Array          | "AnyMatcher":#any_matcher            | if the object is an array, it will create an @AnyMatcher@, where each item of array will be an matcher |
| nil            | "AnythingMatcher":#anything_matcher  | if the object is nil, it will create an @AnythingMatcher@                                              |
| Symbol         | "DuckTypeMatcher":#duck_type_matcher | if the object is a symbol, it will create an @DuckTypeMatcher@ that responds to it                     |
| Hash           | "HashMatcher":#hash_matcher          | if the object is an hash, it will create an @HashMatcher@ with given hash                              |
...
Example:
```ruby
method :something, s(nil) # will accept splat with anything(nil will be converted on "AnythingMatcher":#anything_matcher)
